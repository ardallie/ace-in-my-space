...
- `${CLAUDE_PLUGIN_ROOT}/skills/ace-agent-code-review/SKILL.md` -- Phase 3 shared verification
- `${CLAUDE_PLUGIN_ROOT}/skills/ace-agent-arch-review/SKILL.md` -- Phase 2 shared verification
