...
`${CLAUDE_PLUGIN_ROOT}/skills/ace-detect-harness/models.md`; this file holds the detection procedure, the
...
On success, read `${CLAUDE_PLUGIN_ROOT}/skills/ace-detect-harness/models.md` and print exactly one block:
