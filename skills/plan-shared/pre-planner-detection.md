...
- `${CLAUDE_PLUGIN_ROOT}/skills/ace-plan-start/SKILL.md` -- Phase 2 detection (a match makes the report the
  transform driver)
- `${CLAUDE_PLUGIN_ROOT}/skills/ace-plan-validate/SKILL.md` -- Phase 1 rejection guard (a match stops with a
  `/ace-plan-start` redirect)
- `${CLAUDE_PLUGIN_ROOT}/skills/ace-plan-update/SKILL.md` -- Phase 2A step 1 rejection guard (a match stops
