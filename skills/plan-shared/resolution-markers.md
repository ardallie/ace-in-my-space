...
- `${CLAUDE_PLUGIN_ROOT}/skills/ace-plan-start/SKILL.md` -- Phase 8 (chained write-back)
- `${CLAUDE_PLUGIN_ROOT}/skills/ace-plan-validate/SKILL.md` -- Phase 4 (standalone interview write-back)
...
- `${CLAUDE_PLUGIN_ROOT}/agents/ace-plan-drafter.md` step 1 -- the marker semantics a subagent payload must
  state for itself to stay self-contained.
- `${CLAUDE_PLUGIN_ROOT}/skills/ace-plan-update/SKILL.md` Phase 2A step 3 -- the marker-to-state map, which
