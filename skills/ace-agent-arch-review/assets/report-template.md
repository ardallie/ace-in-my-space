...
`${CLAUDE_PLUGIN_ROOT}/skills/agent-shared/report-conventions.md`. Local addition: the
...
one line in the record grammar of `${CLAUDE_PLUGIN_ROOT}/skills/agent-shared/verification-checks.md`: the
