...
Write the report to `.ace/arch-review/{yyyyMMdd}-{HHmm}-ace-agent-arch-review-{suffix}.md` per the save procedure in `${CLAUDE_PLUGIN_ROOT}/skills/agent-shared/report-conventions.md` `## Save report` (`{suffix}` is the Phase 3 hex suffix).
