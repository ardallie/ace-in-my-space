...
Write the report to `.ace/reports/{yyyyMMdd}-{HHmm}-agent-code-review-{suffix}.md` per the save procedure in `../agent-shared/report-conventions.md` `## Save report` (`{suffix}` is the Phase 3 hex suffix).
