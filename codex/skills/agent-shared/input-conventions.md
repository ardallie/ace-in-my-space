...
- `../agent-pre-planner/SKILL.md` -- full
- `../agent-arch-review/SKILL.md` -- full, with its stated Phase 1 divergences
- `../agent-scope/SKILL.md` -- full, with its stated Phase 1 divergences
- `../agent-code-review/SKILL.md` -- flag pre-pass and residual-token warnings
  only; its positional scope grammar is local to its SKILL.md
- `../agent-consultant/SKILL.md` -- carries its own aligned copy of the flag rules,
  the positional rules, and the residual-token warnings; the `--model` rule below is shared
  with its Phase 1
- `../plan-route/SKILL.md` -- adapted local copies of the positional branches (its
