...
- `../plan-start/SKILL.md` -- Phase 8 (chained write-back)
- `../plan-validate/SKILL.md` -- Phase 4 (standalone interview write-back)
...
- `../../agents/plan-drafter.md` step 1 -- the marker semantics a subagent payload must
  state for itself to stay self-contained.
- `../plan-update/SKILL.md` Phase 2A step 3 -- the marker-to-state map, which
