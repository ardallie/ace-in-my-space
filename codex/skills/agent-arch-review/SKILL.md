...
Write the report to `.ace/arch-review/{yyyyMMdd}-{HHmm}-agent-arch-review-{suffix}.md` per the save procedure in `../agent-shared/report-conventions.md` `## Save report` (`{suffix}` is the Phase 3 hex suffix).
